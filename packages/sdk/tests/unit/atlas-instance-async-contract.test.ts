...
describe('createAtlasInstance — async contract', () => {
  ...
  it('every method on every sub-API returns a Promise', () => {
    ...
    for (const call of [
      ...
      () => atlas.onedrive.restore('o', { snapshotId: 's' }),
      () => atlas.onedrive.save('o', { snapshotId: 's' }),
      ...
      () => atlas.sharepoint.restore('site', { snapshotId: 's' }),
      () => atlas.sharepoint.save('site', { snapshotId: 's' }),
