...
export class SaveService implements SaveUseCase {
  ...
  async save_snapshot(
    ...
    try {
      ...
      return await this.save_batch(ctx, tenant_id, mailbox_id, snapshot_id, entries, options);
    } finally {
      ctx.destroy();
    }
  }
  ...
  async save_mailbox(
    ...
    try {
      ...
      return await this.save_batch(ctx, tenant_id, mailbox_id, 'mailbox', filtered, options);
    } finally {
      ctx.destroy();
    }
  }
